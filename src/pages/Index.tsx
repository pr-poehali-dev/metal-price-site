      ...
      <section id="contacts" className="py-16 bg-primary text-primary-foreground">
        <div className="container px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-primary-foreground/80">Свяжитесь с нами удобным способом</p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-primary-foreground/90">+7 (495) 123-45-67</p>
              <p className="text-primary-foreground/90">+7 (495) 123-45-68</p>
            </div>

            <div className="text-center">
              <Icon name="Mail" className="h-12 w-12 mx-auto mb-4 text-accent" />
              <h3 className="font-semibold mb-2">Email</h3>
              <p className="text-primary-foreground/90">info@metallprom.ru</p>
              <p className="text-primary-foreground/90">sales@metallprom.ru</p>
            </div>

            <div className="text-center">
              <Icon name="MapPin" className="h-12 w-12 mx-auto mb-4 text-accent" />
              <h3 className="font-semibold mb-2">Адрес</h3>
              <p className="text-primary-foreground/90">г. Москва</p>
              <p className="text-primary-foreground/90">ул. Промышленная, 15</p>
            </div>
          </div>
        </div>
      </section>
